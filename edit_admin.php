...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (!empty($row['user_name'])) {
		...
		$_SESSION['failure'] = "Esse nome já existe";
	...
	if ($stat) {
		$_SESSION['success'] = "Funcionário foi atualizado";
	} else {
		$_SESSION['failure'] = "Falha ao atualizar o Admin : " . $db->getLastError();
	}
...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">Atualizar</h2>
		</div>
